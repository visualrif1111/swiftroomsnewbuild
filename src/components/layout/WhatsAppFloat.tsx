...
export default function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="hidden lg:flex fixed bottom-6 right-6 z-50 items-center gap-3 group"
      aria-label="Chat on WhatsApp"
    >
      {hovered && (
        <span className="bg-white shadow-lg border border-gray-100 text-[#1c1c1e] text-xs font-medium px-3 py-2 whitespace-nowrap">
          Chat on WhatsApp
        </span>
      )}
